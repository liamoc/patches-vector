...
operation also has an interpretation in terms of groupoids, where the transform function is essentially a pair of 
/fibrations/ from the present history to the past.
